...
function convertXmlLocation (xmlInput) {
  ...
  '<ns2:portCallId>' + xmlInput[1] + '</ns2:portCallId>' + '<ns2:vesselId>' + xmlInput[2] + '</ns2:vesselId>' + '<ns2:messageId>' + xmlInput[3] + '</ns2:messageId>' + '<ns2:reportedBy>' + xmlInput[4] + '</ns2:reportedBy>' + '<ns2:locationState>' +
  '<ns2:referenceObject>' + xmlInput[5] + '</ns2:referenceObject>' + '<ns2:time>' + xmlInput[6] +
  ':00.000Z</ns2:time>' + '<ns2:timeType>' + xmlInput[7] + '</ns2:timeType>' + '<ns2:arrivalLocation>' +
  '<ns2:to>' + '<ns2:position>' + '<ns2:latitude>0</ns2:latitude>' + '<ns2:longitude>0</ns2:longitude>' + '<ns2:name>' + xmlInput[8] + '</ns2:name>' + '</ns2:position>' + '<ns2:locationType>' + xmlInput[9] + '</ns2:locationType>' + '</ns2:to>' + '</ns2:arrivalLocation>' + '<ns2:departureLocation>' + '<ns2:from>' + '<ns2:position>' + '<ns2:latitude>0</ns2:latitude>' + '<ns2:longitude>0</ns2:longitude>' + '<ns2:name>' + xmlInput[11] + '</ns2:name>' + '</ns2:position>' + '</ns2:from>' + '<ns2:locationType>' + xmlInput[10] + '</ns2:locationType>' + '</ns2:departureLocation>' + '</ns2:locationState>' + '</ns2:portCallMessage>'
  return xml
}
